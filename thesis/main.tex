...
\newcommand{\statedate}{Coimbra, September \YEAR}					% The date, usually "Place, Month Year"
...
\chapter{Subjective Screening Procedures}\label{app:subjective-screening}
\input{appendix/subjective_screening.tex}

\chapter{Full Reference Metrics}\label{app:full-ref-metrics}
\input{appendix/full_reference.tex}

\chapter{Regression Models for Metric Fusion}\label{app:regression-models}
\input{appendix/regression_models.tex}

\chapter{Hardware and Software Environment}\label{app:env}
\input{appendix/ware_environment.tex}
