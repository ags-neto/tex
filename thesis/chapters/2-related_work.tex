...
p{0.50\linewidth}  % Tested Databases
    ...
    \caption{Summary of the 4 \acs{NR}-\acs{IQA} metrics used}\label{tab:nr_iqa_metrics}\\
    \hline % chktex 44
    \textbf{Metric} & \textbf{Year} & \textbf{Category} & \textbf{Tested Databases} \\
    \hline % chktex 44
    \endfirsthead % chktex 1
    ...
    PIQE~\cite{wang2004image} & 2004 & Classical & LIVE, CSIQ, TID2008, TID2013, KADID-10k \\ \hline
    NIQE~\cite{wang2004image} & 2004 & Classical & LIVE, CSIQ, TID2008, TID2013, KADID-10k \\ \hline
    SerFiq~\cite{wang2004image} & 2004 & Classical & LIVE, CSIQ, TID2008, TID2013, KADID-10k \\ \hline
    MagFace~\cite{wang2004image} & 2004 & Classical & LIVE, CSIQ, TID2008, TID2013, KADID-10k \\ \hline
\end{longtable}
